...
<head>
    ...
    <title>Uche | Full stack software Engineer and Cybersecurity Enthusiast. </title>
    <meta name="description" content="I am Uche, A software engineer, Database profesional, Cybersecurity Enthusiast and Reseacher">
    <meta name="author" content="Uche" />
    <link rel="icon" href="images/favicon1.ico" />
    <link rel="stylesheet" href="../../fonts.googleapis.com/css.26079.delayed?family=Poppins:300,400,500,600,700" />
...
<body>
    ...
    <section class="home img-bg" style="background: url(images/bg/bg5.JPG) 0 0; background-size: cover;">
        <div class="overlay opacity5"></div>
        <div class="container">
            <div class="name-block">
                <div class="name-block-container">
                    <h1><span>Hi, I'm</span>Uche</h1>
            ...
            <div class="content-blocks about">
                <section class="content" id="about">
                    <div class="block-content">
                        ...
                        <h3 class="subheading">I'm a <strong>Full stack software developer</strong>, <strong>Database professional</strong>, <strong>Cybersecurity Enthusiast</strong>. I aim to make 
                            a difference through my creative solution.</h3>
                        <p>Worked with project teams to create user-friendly and appealing application interfaces and websites for users. Met with project manager, 
                            business analyst and architect right from beginning of project, creating rough mock-ups that were refined and extended over many iterations. Adjustments to mock-ups as necessary to address problems encountered.</p>
                        <div class="info-list row">
                            <div class="col-sm-6"><span>Name : </span> Uche Nwachukwu .N</div>
                            <div class="col-sm-6"><span>Date of birth : </span> April 09 </div>
                            <div class="col-sm-6"><span>Address : </span> No. B21 Liberty street, el-salem FHA, Lugbe Abuja.</div>
                            <div class="col-sm-6"><span>Email : </span> uchenwofia@outlook.com</div>
                            <div class="col-sm-6"><span>Phone : </span> +2348089480493</div>
                            <div class="col-sm-6"><span>Skype : </span> comrade_uche</div>
                            <div class="col-sm-6"><span>Interest : </span> Business</div>
                        </div>
                        <img class="sign" src="images/signature.png" alt="" />
                    </div>
                    <div class="block-content">
                        <h3 class="block-title">Skills</h3>
                        <label class="progress-bar-label">PHP - <span> 9 years experience</span></label>
                        <div class="progress">
                            <div style="width: 94%;" class="progress-bar" role="progressbar" aria-valuenow="94" aria-valuemin="0" aria-valuemax="100">
                                <span>94%</span>
                            </div>
                        </div>
                       <label class="progress-bar-label">Python - <span> 2 years experience</span></label>
                        <div class="progress">
                            <div style="width: 73%;" class="progress-bar" role="progressbar" aria-valuenow="73" aria-valuemin="0" aria-valuemax="100">
                                <span>73%</span>
                            </div>
                        </div>
                        <label class="progress-bar-label">Relational Database - <span>9 years experience</span></label>
                        <div class="progress">
                            <div style="width: 95%;" class="progress-bar" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
                                <span>89%</span>
                            </div>
                        </div>
                        <label class="progress-bar-label">HTML&amp;CSS - <span>9 years experience</span></label>
                        <div class="progress">
                            <div style="width: 99%;" class="progress-bar" role="progressbar" aria-valuenow="99" aria-valuemin="0" aria-valuemax="100">
                                <span>95%</span>
                            </div>
                        </div>
                        <label class="progress-bar-label">Javascript - <span>8 years experience</span></label>
                        <div class="progress">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="exp-holder">
                                        <div class="exp">
                                            <div class="hgroup">
                                                <h4><span>Co-founder</span> @Uche Nwofia & co. ltd </h4>
                                                <h5>Mar 2017 - <span class="current">present</span></h5>
                                            </div>
                                            <p>Direct and administer all engagements that involves the cooperate professional service rendering such as Business Analysis and Execution..</p>
                                        </div>
                                        <!--<div class="exp">
                                            <div class="hgroup">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="exp-holder">
                                        ...
                                        <div class="exp">
                                            <div class="hgroup">
                                                <h4>Diploma in Computer Science | <span>Institute of Management & Tech, IMT Enugu</span></h4>
                                                <h5>Jan 2010 - Nov 2014</h5>
                                            </div>
                                            <p>Obtained Diploma in computer science from the Institute of management and Technology Enugu.
                                            </p>
                                        </div>
                                        
                                        <div class="exp">
                                            <div class="hgroup">
                                                <h4>Oracle Certified Professional | <span> New Horizon, Abuja</span></h4>
                                                <h5>Mar 2016 - Nov 2016</h5>
                                            </div>
                                            <p>Studied Oracle Database Technology @ New Horizon .
                                            </p>
                                        </div>
                                        
                                        <div class="exp">
                                            <div class="hgroup">
                                                <h4>Web Application Development | <span>AfriHub, IMT campus, Enugu</span></h4>
                                                <h5>May 2017 - Sept 2017</h5>
                                            </div>
                                            <p>Studied BackEnd, FrontEnd and Server side web application development.
                                            </p>
                                        </div>
                    ...
                    <div class="block-content">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 service">
                                ...
                                <p>I analyse, design and develop diverse hybrid web and cloud application... 
                                  .</p>
                            </div>
                            <div class="col-md-4 col-sm-6 service">
                                <div class="service-icon">
                                ...
                                <h4>Cybersecurity / Security Research</h4>
                                <p>Investigate softwares for possible vulnerability.</p>
                            </div>
                            <div class="col-md-4 col-sm-6 service">
                                <div class="service-icon">
                                ...
                                <h4>Database</h4>
                                <p>We manage, modify and maintain relational database technologies.</p>
                            </div>
                            <div class="col-md-4 col-sm-6 service">
                                <div class="service-icon">
                                ...
                                <h4>Graphics</h4>
                                <p>My team of graphic experts can deliver on all graphics related services, 
                                    such as designing of logo, icon and portfolio.</p>
                            </div>
                            <div class="col-md-4 col-sm-6 service">
                                <div class="service-icon">
                                    <i class="ion-qr-scanner"></i>
                                </div>
                                <h4>Search Engine Optimization (S.E.O)</h4>
                                <p>We deliver services such as hardware maintenance and purchase for all purpose and magnitude.</p>
                            </div>
                            <div class="col-md-4 col-sm-6 service">
                                <div class="service-icon">
                                ...
                                <h4>CMS</h4>
                                <p>We design, develop, deploy and maintain content management systems of all sort using
                                    built on wordpress, joomla, Drupal et la.</p>
                            </div>
                        </div>
                    </div>
                    <!--<div class="block-content">
    ...
    <script src="../../maps.googleapis.com/maps/api/js.246c5d.delayed?key=AIzaSyAmsb2nGLuIl04bt7CWJozRMhThvGa3y1w"></script>
